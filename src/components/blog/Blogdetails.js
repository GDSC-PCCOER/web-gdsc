  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="gdsc blogs details, gdsc  blogs details, gdsc  blogs details, dsc, dsc  blogs details, dsc  blogs details, gdsc blogs details, dsc blogs details, dsc blogs details,  dsc blogs details,  dsc blogs details,  gdsc blogs details, gdsc- blogs details, gdsc blogs details, dsc blogs details, dsc blogs details"
        />
      </Helmet>
      <div
        data-aos="fade-up"
