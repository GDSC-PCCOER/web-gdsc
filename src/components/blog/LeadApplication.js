  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="keywords"
          content="gdsc blogs lead application guide, gdsc pccoer blogs lead application guide, gdsc pccoer blogs lead application guide, dsc, dsc pccoer blogs lead application guide, dsc pccoer blogs lead application guide, gdsc blogs lead application guide, dsc blogs lead application guide, dsc blogs lead application guide, pccoer dsc blogs lead application guide, pccoer dsc blogs lead application guide, pccoer gdsc blogs lead application guide, gdsc-pccoer blogs lead application guide, gdsc blogs lead application guide, dsc-pccoer blogs lead application guide, dsc blogs lead application guide"
        />
      </Helmet>
      <div
        data-aos="fade-up"
              ...
              <div className="blog-post-content max-width-2 m-auto my-2 m-auto">
                ...
                <div className="blogpost-meta">
                  <div className="author-info">
                    <div>
                      <b>Abhay Rajput: Lead - GDSC, PCCOER</b>
                    </div>
                    <div>31st March 2022 | 10 mins</div>
                  </div>
                  <div className="social">
                    <a
                      href={`mailto:abhayrajput@gmail.com`}
                      target="_blank"
                      rel="noreferrer"
                      className="mr-3"
                      title="Mail"
                ...
                <div className="font1">
                  <p>
                    Hi everyone! I’m Abhay Rajput, the founder and the Lead at
                    Google Developer Student Clubs, PCCOER. I started GDSC at my
                  ...
                  <ul>
                    ...
                    <li>
                      - Cool swags and goodies (that’s the last thing we should
                      look upto, but yes it adds in motivation!)
                    </li>
                  </ul>
                  <p>
                    My onboarding kit -{" "}
                  ...
                  <ol>
                    ...
                    <ul>
                      ...
                      <li>
                        Check it out -{" "}
                        <a
                          href="https://vedantaz.github.io/web_gdsc/"
                          target="_blank"
                          rel="noreferrer"
                          className="text-primary"
                        >
                          https://vedantaz.github.io/web_gdsc/
                        </a>
                      </li>
                    </ul>
                    <li>
                  ...
                  <ol>
                    ...
                    <li>
                      Amazing core team to work with - I didn't even know these
                  ...
                  <p>
                    ...
                    <a
                      ...
                      className="text-primary"
                    >
                      https://www.linkedin.com/in/abhay-rajput-2a84b81b7/
                    </a>
                  </p>
