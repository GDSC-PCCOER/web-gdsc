    ...
    if (
      ...
      emailjs
        .send(
          ...
          "template_0rti798",
          {
            to_name: "Abhay Rajput",
            to_email: "abhayrajput@gmail.com",
            from_name: "GDSC, PCCOER",
            name: values.name,
            email: values.email,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="gdsc events, gdsc  events, gdsc   events, dsc, dsc  events, dsc   events, gdsc  events, dsc  events,  dsc events,  dsc events,   dsc events,   gdsc events, gdsc-- events, gdsc- events, dsc-- events, dsc- events"
        />
      </Helmet>
