  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="gdsc event details, gdsc  event details, gdsc  event details, dsc, dsc  event details, dsc  event details, gdsc event details, dsc event details, dsc event details,  dsc event details,  dsc event details,  gdsc event details, gdsc- event details, gdsc event details, dsc- event details, dsc event details"
        />
      </Helmet>
      <div
        data-aos="fade-up"
