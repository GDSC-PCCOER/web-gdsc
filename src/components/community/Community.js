  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="gdsc about, gdsc  about, gdsc  about, dsc, dsc  about, dsc  about, gdsc about, dsc about, dsc about,  dsc about,  dsc about,  gdsc about, gdsc- about, gdsc about, dsc- about, dsc about"
        />
      </Helmet>
              ...
              <div className="card who">
                <div className="card-body">
                  ...
                  <p className="card-text pt-2 text-center">
                    We at GDSC, Pimpri Chinchwad College of Engineering, Ravet
                    are ambitious towards building a community that aims to
                    change the world with technology. We do this by organizing
