const upcoming = [
  {
    ...
    day: "Sunday",
    about:
      "☀️ Google Summer of Code ☀️ with Google Developer Student Clubs!. 🔵🟢🔴🟡. 👨‍🏫 A beginner's guide to -. 📌 Open Source. 📌 Roadmap to GSOC. 📌 How to find organizations and start contributing?. 📌 How to draft a proposal?. 📌 Other Open Source Programs like MLH Fellowship, Outreachy, Github Externship, LFX and more!. 🤝 Meet Kumar Saurabh Raj from GSOC'21, Incoming IBM Research CERN, former GDSC Lead. 🗓 - 03/04/2022, Sunday. 🕐 - 03:00PM IST. 📍 - https://gdsc.community.dev/e/mp6an6/. RSVP Now!. Regards,. GDSC PCCOER. GDSC Delhi Technical Campus. GDSC Sathyabama Institute of Science and Technology",
    speaker:
      "Kumar Saurabh Raj from GSOC'21, LFX, xIncoming IBM Research CERN, Former GDSC Lead",
    eventLink: "/",
