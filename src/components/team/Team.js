  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Have a look at the great minds of GDSC PCCOER. None of us, including me, ever do great things. But we can all do small things, with great love, and together we can do something wonderful."
        />
        <meta
          name="keywords"
          content="gdsc team, gdsc  team, gdsc PCCOER team, dsc, dsc  team, dsc PCCOER team, gdsc  team, dsc  team,  dsc team,  dsc team, PCCOER dsc team, PCCOER gdsc team, gdsc-- team, gdsc- team, dsc-- team, dsc- team"
        />
      </Helmet>
            ...
            <div className="col-lg-6 col-sm-6">
              ...
              <div>
                <span
                  ...
                  data-tooltip="Hi! I'm Abhay Rajout. I love to sleep but coding is my coffee ;) I enjoy problem solving and competitive coding. I'm currently learning Node.js and I'm loving it. Can't wait to meet you guys in a GDSC offline event!"
                >
                  <img
                    src={Abhay}
              ...
              <div className="social-ico">
                ...
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://www.instagram.com/rajputabhay"
                >
            ...
            <div className="col-lg-6 col-sm-6 teams">
              ...
              <div className="social-ico">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://www.linkedin.com/in/sonali-lunawat/"
                >
                  <i className="fa fa-linkedin ico-link"></i>
                </a>
                ...
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://sonallunawat4u.wordpress.com/"
                >
                  <i className="fa fa-link ico-link"></i>
                </a>
              </div>
          ...
          <div className="col-lg-6 col-sm-6 teams">
            ...
            <div className="social-ico">
              <a
                target="_blank"
                rel="noreferrer"
                href="https://www.linkedin.com/in/rajat-deore-072260220/"
              >
                <i className="fa fa-linkedin ico-link"></i>
              </a>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://github.com/RajatDeore7"
              >
                <i className="fa fa-github ico-github"></i>
              </a>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://www.instagram.com/rajat.72002/"
              >
                <i className="fa fa-instagram ico-insta"></i>
              </a>
            </div>
          ...
          <div className="col-lg-6 col-sm-6 teams">
            ...
            <div className="social-ico">
              <a
                target="_blank"
                rel="noreferrer"
                href="https://www.linkedin.com/in/vedant-mule-210854219/"
              >
                <i className="fa fa-linkedin ico-link"></i>
              </a>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://github.com/Vedantaz/"
              >
                <i className="fa fa-github ico-github"></i>
              </a>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://www.instagram.com/muley635/"
              >
                <i className="fa fa-instagram ico-insta"></i>
              </a>
            </div>
          ...
          <div className="col-lg-6 col-sm-6 teams">
            ...
            <div className="social-ico">
              <a
                target="_blank"
                rel="noreferrer"
                href="https://www.linkedin.com/in/jay-firke-0aa416121"
              >
                <i className="fa fa-linkedin ico-link"></i>
              </a>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://github.com/jayfirke"
              >
                <i className="fa fa-github ico-github"></i>
              </a>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://instagram.com/jayfirke"
              >
                <i className="fa fa-instagram ico-insta"></i>
              </a>
            </div>
          ...
          <div className="col-lg-6 col-sm-6 teams">
            ...
            <div className="social-ico">
              <a
                target="_blank"
                rel="noreferrer"
                href="https://www.linkedin.com/in/pritam-patil-621925219"
              >
                <i className="fa fa-linkedin ico-link"></i>
              </a>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://github.com/Pritam1222"
              >
                <i className="fa fa-github ico-github"></i>
              </a>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://instagram.com/pp_12.22?igshid=YmMyMTA2M2Y="
              >
                <i className="fa fa-instagram ico-insta"></i>
              </a>
            </div>
